<?php return array (
  ...
  'manager.people.allEnrolledUsers' => 'Utilisateurs inscrits à cette presse',
...
<p><strong>Note:</strong> en vue de compléter le processus de vérifications des références dans des délais raisonnables, la directive <tt>citation_checking_max_processes</tt> dans votre fichier de configuration doit être paramétré à une valeur raisonnable. Voir la section "General Settings" dans <tt>config.inc.php</tt> pour plus d\'information.</p>',
  ...
  'manager.setup.competingInterestsDescription' => 'Les évaluateurs devront respecter la politique de divulgation des intérêts concurrents que vous spécifiez ci-dessous.',
  ...
  'manager.setup.reviewOptions.remindForInvite' => 'Envoyer un rappel si l\'évaluateur n\'a pas répondu à la demande d\'évaluation dans le délai suivant (jours):',
  'manager.setup.reviewOptions.remindForSubmit' => 'Envoyer un rappel si l\'évaluateur n\'a pas fait sa recommandation dans le délai suivant (jours):',
...
Il arrive parfois qu\'une seule statistique d\'utilisation doit être utilisée, par exemple pour afficher une liste ordonnée des soumissions les plus utilisées ou pour ordonner les résultats de la recherche. Veuillez choisir l\'une des mesures configurées à titre de mesure par défaut.',
  ...
  'manager.setup.styleSheetDescription' => 'Vous pouvez télécharger un fichier CSS (feuille de style en cascade) supplémentaire pour modifier l\'apparence du site Web.',
  ...
  'manager.setup.principalContactDescription' => 'Entrer les coordonnées d\'un membre de la rédaction ou du personnel administratif qui peuvent être affichées sur votre site Web.',
  ...
  'manager.setup.reviewOptions.showBlindReviewLink' => 'Présenter un lien "Assurer une évaluation à l\'aveugle" lors du téléchargement',
  ...
  'manager.setup.technicalSupportContact' => 'Soutien technique',
  'manager.setup.technicalSupportContactDescription' => 'Une personne-ressource qui peut aider les rédacteurs, les auteurs et les évaluateurs avec toutes difficultés rencontrées durant la soumission, l\'évaluation, l\'édition ou la publication.',
  ...
  'settings.roles.recommendOnly' => 'Ce rôle est seulement autorisé à recommander une décision éditoriale. Un rédacteur devra enregistrer la décision finale.',
  ...
  'manager.navigationMenus.form.duplicateTitles' => 'Ce titre existe déjà dans un autre menu de navigation.',
  ...
  'manager.navigationMenus.form.conditionalDisplay' => 'Apprendre davantage sur l\'affichage ou le masquage de cet élément du menu.',
  ...
  'manager.navigationMenus.loggedOut.conditionalWarning' => 'Ce lien ne sera affiché que si le visiteur s\'est connecté.',
  'manager.navigationMenus.loggedIn.conditionalWarning' => 'Ce lien ne sera affiché que si le visiteur ne s\'est pas connecté.',
  'manager.setup.privacyStatement.description' => 'Cette déclaration apparaîtra lors de l\'inscription de l\'utilisateur, de la soumission d\'un article et sur la Page de confidentialité accessible au public. Dans certaines juridictions, vous êtes légalement tenus de divulguer la manière dont vous gérez les données utilisateurs dans une politique de confidentialité.',
  'manager.setup.searchEngineIndexing.sitemap' => 'Sitemap',
  'manager.setup.searchEngineIndexing.sitemapDescription' => 'Un sitemap XML est disponible pour la soumission aux moteurs de recherche à <a href="{$path}" target="_blank">{$path}</a>',
  'settings.libraryFiles.public.viewInstructions' => '<p>Ce fichier peut être accessible pour téléchargement, si "Accès public" est activé, à:<blockquote>{$downloadUrl}</blockquote></p>',
  'settings.libraryFiles.public.selectLibraryFiles' => 'Sélectionner le fichier à joindre',
  'manager.setup.genres.key' => 'Clé',
  'manager.setup.genres.key.description' => 'Un identifiant optionnel, symbolique et court pour ce genre.',
  ...
  'manager.navigationMenus.contact.description' => 'Lien vers une page affichant vos informations de contact.',
  'manager.navigationMenus.contact.conditionalWarning' => 'Ce lien ne sera affiché que si vous avez rempli les informations de contact sous Paramètres> Revues> Contact.',
  ...
  'manager.navigationMenus.mySubscriptions.conditionalWarning' => 'Ce lien ne sera affiché que si le visiteur est connecté, si les paiements sont activés dans  Paramètres> Distribution> Paiements et si l\'abonnement est exigé dans Paramètres> Distribution> Accès.',
