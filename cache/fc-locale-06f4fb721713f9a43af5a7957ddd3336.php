<?php return array (
  ...
  'plugins.pubIds.urn.description' => 'Este plugin permite a atribuição de Uniform Resource Names aos números, artigos e composições no OJS.',
  'plugins.pubIds.urn.manager.settings.description' => 'Configure o plugin URN para gerire usar URNs no OJS:',
  'plugins.pubIds.urn.manager.settings.urnObjects' => 'Conteúdo Revista',
  'plugins.pubIds.urn.manager.settings.urnObjectsRequired' => 'Seleccione as publicações às quais devem ser atribuídos os URNs .',
  'plugins.pubIds.urn.manager.settings.explainURNs' => 'Seleccione as publicações que terão Uniform Resource Names (URN) atribuídos:',
  'plugins.pubIds.urn.manager.settings.enableIssueURN' => 'Números',
  'plugins.pubIds.urn.manager.settings.enableSubmissionURN' => 'Artigos',
  ...
  'plugins.pubIds.urn.manager.settings.urnPrefix.description' => 'O prefixo URN é a correcção, nunca mudando parte da URN (por exemplo, "urn: nbn: de: 0000-").',
  'plugins.pubIds.urn.manager.settings.form.urnPrefixPattern' => 'O prefixo padrão do URN deve estar sob a forma "urn:"&lt;NID gt;":"& lt;NSS&gt ;',
  ...
  'plugins.pubIds.urn.manager.settings.urnSuffixPattern' => 'Use o padrão inserido abaixo para gerar sufixos URN. Use %j para as iniciais da revista, %v para volume, %i para o número, %Y para o ano, %a para o ID do artigo, %g para a ID da composição, %f para o ID do ficheiro, %P para o número da página e %x para "Custom Identifier".',
  ...
  'plugins.pubIds.urn.manager.settings.urnSubmissionSuffixPatternRequired' => 'Insira o sufixo padrão URN para artigos.',
  'plugins.pubIds.urn.manager.settings.urnRepresentationSuffixPatternRequired' => 'Insira o sufixo padrão URN para composições.',
  'plugins.pubIds.urn.manager.settings.urnSuffixDefault' => 'Usar padrão',
  'plugins.pubIds.urn.manager.settings.urnSuffixDefault.description' => '%j.v%vi%i para números<br />%j.v%vi%i.%a para artigos<br />%j.v%vi%i.%a.g%g para composições.',
  ...
  'plugins.pubIds.urn.manager.settings.checkNo' => 'Número Verificação',
  ...
  'plugins.pubIds.urn.manager.settings.namespace.choose' => 'Seleccione',
