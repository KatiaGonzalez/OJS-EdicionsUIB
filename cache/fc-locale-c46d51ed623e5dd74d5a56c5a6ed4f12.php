...
<strong>Manager Only</strong>: Only the Journal Manager may use this deposit point. The URL indicates a service document. Deposit is manually performed by the Journal Manager using the Import/Export interface in Journal Management.
  ...
  'plugins.importexport.sword.requiredFieldErrorTitle' => 'Submission required',
  'plugins.importexport.sword.requiredFieldErrorMessage' => 'Please select at least one submission to deposit.',
  'plugins.generic.sword.settings.saved' => 'Settings saved!',
  'plugins.generic.sword.manager.noneCreated' => 'No deposit points have been created.',
); ?>