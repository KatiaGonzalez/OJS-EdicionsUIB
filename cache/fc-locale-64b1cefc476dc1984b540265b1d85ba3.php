<?php return array (
  ...
  'grid.action.reload' => 'Télécharger de nouveau',
  ...
  'grid.action.readReview' => 'Lire cette évaluation',
  'grid.action.email' => 'Envoyer un courriel',
  'grid.action.addReviewer' => 'Ajouter un évaluateur',
  'grid.action.selectFiles' => 'Sélectionner les fichiers à gérer',
  'grid.action.accept' => 'Accepter cette soumission',
  'grid.action.internalReview' => 'Envoyer cette soumission à un évaluateur interne',
  'grid.action.externalReview' => 'Envoyer cette soumission à un évaluateur externe',
  'grid.action.sendToProduction' => 'Envoyer cette soumission à la production.',
  'grid.action.requestAccount' => 'Ajouter un participant',
  'grid.action.notify' => 'Aviser cet utilisateur',
  'grid.action.details' => 'Visionner cet item',
  'grid.action.selectCreate' => 'Créer un nouvel évaluateur',
  ...
  'grid.action.enrolExisting' => 'Inscrire un nouvel utilisateur à titre d\'évaluateur',
  'grid.action.sendReminder' => 'Envoyer un rappel de tâche à cet utilisateur',
  'grid.action.viewReviewGuidelines' => 'Voir les lignes directrices des évaluations',
  'grid.action.viewCompetingInterestGuidelines' => 'Voir la politique concernant les intérêts opposés',
  'grid.action.thankReviewer' => 'Envoyer un message de remerciement à cet évaluateur',
  ...
  'grid.action.unassignUser' => 'Retirer l\'utilisateur',
  'grid.action.unconsiderReview' => 'Cette évaluation est terminée, mais vous pouvez ne pas en tenir compte.',
  ...
  'grid.task.status.reviewReady' => 'Cette évaluation est terminée. Cliquez sur l\'icône de note à gauche pour la lire.',
  ...
  'grid.user.mustChangePasswordDescriptionOld' => 'Exiger que l\'utilisateur change son mot de passe la prochaine fois qu\'il ouvrira une session.',
  ...
  'grid.user.mergeUsers.confirm' => 'Voulez-vous vraiment fusionner le compte dont le nom d\'utilisateur est "{$oldUsername}" avec le compte dont le nom d\'utilisateur est "{$newUsername}"? Le compte "{$oldUsername}" n\'existera plus. Cette action est irréversible.',
  ...
  'grid.action.unassignReviewer' => 'Retirer cet évaluateur',
  ...
  'grid.userGroup.cantRemoveDefaultUserGroup' => 'Le rôle {$userGroupName} est un rôle par défaut et ne peut être retiré.',
  'grid.userGroup.cantRemoveUserGroup' => 'Impossible de retirer le rôle {$userGroupName} car il est présentement assigné à {$usersCount} utilisateur(s).',
  ...
  'grid.submission.active.selectOrphaned' => 'Inclure les soumissions incomplètes qui n\'ont pas été soumises par un auteur.',
  'grid.action.addNavigationMenu' => 'Ajouter Menu',
  'grid.action.addNavigationMenuItem' => 'Ajouter élément',
