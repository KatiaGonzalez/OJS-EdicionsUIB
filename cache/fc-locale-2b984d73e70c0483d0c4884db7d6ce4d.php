<?php return array (
  ...
  'grid.contributor.title' => 'Colaborador',
  ...
  'grid.artworkFile.copyrightOwner' => 'Proprietário do Copyright',
  ...
  'grid.userGroup.assignStage' => 'Etapa Designação',
  ...
  'grid.action.updateQuery' => 'Actualizar discussão',
  ...
  'grid.action.selectFiles' => 'Seleccionar ficheiros para gerir',
  ...
  'grid.action.orderItems' => 'Activar modo de pedido',
  'grid.action.editSubmissionChecklist' => 'Editar este item da lista de verificação',
  'grid.action.deleteSubmissionChecklist' => 'Eliminar este item da lista de verificação',
  ...
  'grid.action.disableEmail' => 'Desactivar este modelo de e-mail',
  ...
  'grid.action.viewReviewGuidelines' => 'Ver as diretrizes de revisão',
  'grid.action.viewCompetingInterestGuidelines' => 'Ver a política de directrizes de interesses concorrentes',
  ...
  'grid.action.unconsiderReview' => 'Esta revisão está completa, mas pode ignorá-la.',
  ...
  'grid.user.disableReason' => 'Razão para desactivar utilizador',
  'grid.user.enableReason' => 'Razão para activar utilizador',
  ...
  'grid.user.authSource' => 'Fonte Autenticação',
  ...
  'grid.user.selectUser' => 'Seleccionar Papel',
  'grid.user.pleaseSelectUser' => 'Seleccionar um utilizador',
  ...
  'grid.plugin.disable' => 'Tem certeza que pretende desactivar este plugin?',
  ...
  'grid.userGroup.cantRemoveUserGroup' => 'Não é possível remover o papel {$userGroupName}. Actualmente, {$usersCount} utilizador(s) é/são atribuídos a este.',
