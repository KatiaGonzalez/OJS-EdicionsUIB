<?php return array (
  ...
  'article.discipline' => 'Área e sub-área do Conhecimento Acadêmico',
...
Escolha um modelo para administrar os aspectos do processo editorial. (Para designar um Director e Editores de Secção, aceda a opção Editores em Administração da Revista.)',
  ...
  'sectionEditor.regrets.title' => '#{$submissionId} Arrependimentos, Cancelamentos & Rondas',
  ...
  'layoutEditor.galley.uploadGalleyFormat' => 'Upload formato edição',
...
(Após guardar, outros comentários podem ser incluídos.)',
  ...
  'user.register.form.privacyConsentThisContext' => 'Eu aceito que meus dados sejam coletados e armazenados de acordo com a política de privacidade desta revista <a href="{$privacyUrl}" target="_blank"> Política de privacidade</a>.',
  'user.register.form.missingSiteConsent' => 'Você deve aceitar a política de privacidade do site',
...
<li>Use <strong>*</strong> como caracter coringa; ex.: <em>soci* moralidade</em> recuperará documentos contendo "sociedade" ou "sociológico"</li>
  ...
  'article.nonpdf.note' => 'O documento seleccionado deverá ser transferido automaticamente. Em caso negativo, clique no atalho abaixo. Note que o documento pode requerer um visualizador especial ou extensão para ser executado.<br /><br />Caso o documento não seja transferido automaticamente, <a href="{$url}">clique aqui</a>.',
...
<p>Defina a variável "instalado", no documento de configuração config.inc.php, de novo para <em>On</em>.</p>',
  ...
  'log.review.reviewerUnassigned' => '{$reviewerName} liberada(o) da ronda {$round} de revisão da submissão {$submissionId}.',
  'log.review.reviewInitiated' => 'A ronda {$round} de revisão da submissão {$submissionId}, designada a {$reviewerName}, foi iniciada.',
  'log.review.reviewReinitiated' => 'A ronda {$round} de revisão da submissão {$submissionId}, designada a {$reviewerName}, foi iniciada novamente.',
  'log.review.reviewCleared' => '{$reviewerName} foi liberada(o) da ronda {$round} de revisão da submissão {$submissionId}.',
...
A validação pode falhar em URLs para pesquisa que requeiram dados via método POST.',
  ...
  'manager.setup.authorCopyrightNotice.sample' => '<h3>Proposta de Aviso de Direitos de Autor Creative Commons</h3>
...
<h4>Proposta de Política para Revista que oferecem Acesso Livre Adiado</h4>
Autores que publicam nesta revista concordam com os seguintes termos:
<ol type="a">
...
<ol>
  ...
  'submission.layout.imageInvalid' => 'Formato de imagem inválido. Formatos aceites são .gif, .jpg ou .png.  Verifique as configurações de MimeType do servidor e permissões de pastas.',
  ...
  'log.review.reviewDeclinedByProxy' => '{$userName} marcou indisponibilidade na ronda {$round} para rever a submissão {$submissionId} em nome de {$reviewerName}.',
  'log.editor.decision' => 'A Decisão Editorial ({$decision}) sobre a submissão {$submissionId} foi registada por {$editorName}.',
  ...
  'user.noRoles.regReviewerClosed' => 'Registar-se como Revisor: o registo de revisores está actualmente desactivado.',
  'issue.coverPage.altText' => 'Capa da revista',
  'submission.layout.publicGalleyId' => 'Identificador Público de Edição',
  'submission.layout.galleyPublicIdentificationExists' => 'Identificador público de edição já existe.',
...
Pode-se opcionalmente informar o motivo pelo qual está sendo desactivado o registo.',
  ...
  'notification.type.editorDecisionComment' => 'Foi produzido um comentário sobre a decisão editorial de "{$title}".',
  ...
  'editor.issues.futureIssues' => 'Próximos',
  'editor.issues.backIssues' => 'Anteriores',
  'submission.layout.galley.remotelyHostedContent' => 'Esta edição estará disponível num site separado.',
  ...
  'user.register.contextsPrompt' => 'Em quais revistas deste portal pretende se registar?',
  ...
  'user.role.subEditors' => 'Editores Secção',
  ...
  'search.results.orderBy.article' => 'Título Artigo',
  'search.results.orderBy.author' => 'Autor',
  'search.results.orderBy.date' => 'Data Publicação',
  'search.results.orderBy.issue' => 'Número',
  'search.results.orderBy.journal' => 'Título Revista',
  ...
  'plugins.categories.viewableFiles' => 'Plugins de Ddição de Artigos',
  'plugins.categories.viewableFiles.description' => 'Os plugins da Edição de Artigos suporta a exibição de diferentes tipos de documentos como as edições de artigos.',
...
Setting up CLOCKSS support for Open Journal Systems does not need to take place until after publishing is fully underway.',
  ...
  'user.register.selectContext' => 'Seleccione uma revista para se registar:',
  ...
  'article.download' => 'Download este ficheiro PDF',
  'article.pluginMissing' => '<p>O ficheiro PDF que seleccionou deve carregar aqui se o navegador da Web tiver um plugin de leitor de PDF instalado (por exemplo, uma versão recente de <a href="https://get.adobe.com/reader/">Leitor Adobe Acrobat</a>).</p>',
...
<p>2. A directory to store uploaded files must be created and made writable (see "File Settings" below).</p>',
  ...
  'notification.savedIssueMetadata' => 'Guardados os metadados do número publicado.',
  'notification.type.editorAssignmentTask' => 'Um novo artigo foi submetido para o qual tem de ser designado um Editor.',
  'notification.type.assignProductionUser' => 'Designe um utilizador para criar uma edição usando o link Adicionar na lista Participantes.',
  'notification.type.awaitingRepresentations' => 'Edições em Espera',
  'user.authorization.noContext' => 'Nenhuma revista no contexto!',
  'user.authorization.invalidIssue' => 'Pedido de número inválido!',
  'grid.action.createContext' => 'Criar Nova Revista',
  'notification.type.approveSubmission' => 'Esta submissão está actualmente aguardando aprovação antes que seja associada a um número.',
  ...
  'article.view.interstitial' => 'Escolha um ficheiro do artigo para fazer o download.',
  'grid.catalogEntry.availableRepresentation.approved' => 'Aprovado',
  'grid.catalogEntry.availableRepresentation.notApproved' => 'Aguardando Aprovação',
  'grid.catalogEntry.approvedRepresentation.title' => 'Aprovação Edição',
  'grid.catalogEntry.approvedRepresentation.message' => '<p>Aprovar esta edição para publicação.</p>',
  'grid.catalogEntry.approvedRepresentation.removeMessage' => '<p>Remover aprovação desta edição.</p>',
  'search.cli.rebuildIndex.indexing' => 'Indexão "{$journalName}"',
  ...
  'manager.setup.porticoDescription' => 'O Portico é um serviço sem fins lucrativos com vista à preservação de publicações digitais, incluindo revistas eletrónicas, e-books, e outras coleções históricas digitalizadas. Se a sua revista tiver um contrato com o Portico, poderá ativá-lo aqui:',
  'payment.type.publication.required' => 'A taxa de publicação está em pagamento.',
  'payment.requestPublicationFee' => 'Solicitar taxa de publicação ({$feeAmount})',
  'payment.notFound' => 'Foi solicitado um pagamento, mas o prazo expirou. Contacte o Gestor da Revista para mais informação.',
  'navigation.subscriptions' => 'Subscrições',
  'log.editor.submissionExpedited' => '{$editorName} tomou o processo de edição do artigo {$submissionId}.',
  'notification.type.publicationScheduled' => 'Esta submissão foi agendada para publicação.',
