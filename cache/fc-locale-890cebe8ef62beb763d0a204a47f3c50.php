<?php return array (
  ...
  'common.uploadFailed' => 'Le fichier n\'a pu être téléversé. Veuillez essayer de nouveau ou communiquer avec l\'administrateur si le problème persiste.',
  ...
  'notification.addedReviewer' => '{$reviewerName} a été assigné(e) comme évaluateur pour cette soumission et un courriel d\'avis lui a été envoyé.',
  ...
  'notification.type.awaitingCopyedits' => 'En attente des modifications.',
  ...
  'common.subtitle.tip' => 'Le titre sera suivi de deux points et du sous-titre, facultatif.',
  ...
  'review.ensuringBlindReview' => 'Assurer une évaluation anonyme',
  ...
  'review.blindPeerReview' => '<p>Afin d\'assurer l\'intégrité de l\'examen en aveugle des soumissions envoyées à cette presse, il faut faire tous les efforts possibles pour éviter de révéler l\'identité des auteurs et des évaluateurs. Pour ce faire, les auteurs, les rédacteurs et les évaluateurs (qui téléchargent les documents dans le cadre de l\'évaluation) doivent s\'assurer de suivre les étapes suivantes en ce qui concerne les propriétés du texte et du fichier:</p>
...
<li>Pour les fichiers PDF, le nom de l\'auteur doit être enlevé des propriétés du document dans le menu Fichier, du menu principal d\'Adobe Acrobat.</li>
  ...
  'semicolon' => '{$label}:',
  'notification.addedReviewerNoEmail' => '{$reviewerName} a été assigné(e) à l\'évaluation de cette soumission sans que ne lui soit envoyé un courriel d\'avis.',
  'common.deleting' => 'Supprimer',
  'common.from' => 'De',
  'common.until' => 'À',
  'common.saving' => 'Enregistrer',
  'stageParticipants.options' => 'Privilèges',
  'stageParticipants.recommendOnly' => 'Ce participant est seulement autorisé à recommander une décision éditoriale. Un Rédacteur autorisé devra enregistrer la décision.',
  'notification.reviewerThankedEmail' => 'Courriel de remerciement envoyé à l\'évaluateur.',
  'notification.editedNavigationMenuItem' => 'L\'élément du menu de navigation a été correctement mis à jour.',
  'notification.removedNavigationMenuItem' => 'L\'élément du menu de navigation a été correctement retiré',
  'notification.addedNavigationMenuItem' => 'L\'élément du menu de navigation a été correctement ajouté',
  'notification.addedNavigationMenu' => 'Le menu de navigation a été correctement ajouté',
  'notification.editedNavigationMenu' => 'Le menu de navigation a été correctement mis à jour.',
  'notification.removedNavigationMenu' => 'Le menu de navigation a été correctement retiré',
  'notification.sendNotificationConfirmation' => 'Envoyer un courriel d\'avis à tous les utilisateurs enregistrés',
  ...
  'stageParticipants.notify.startDiscussion.description' => 'Commencer une discussion entre {$userFullName} et vous.',
  'list.viewMore' => 'Afficher plus de détails sur {$name}',
  'list.viewLess' => 'Masquer les détails sur {$name}',
