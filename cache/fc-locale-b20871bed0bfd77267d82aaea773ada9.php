<?php return array (
  ...
  'user.register.form.usernameAlphaNumeric' => 'Le nom d\'utilisateur ne peut contenir que des caractères alphanumériques minuscules, traits de soulignement et traits d\'union. Il doit commencer et se terminer par un caractère alphanumérique. Le caractère espace n\'est pas permis.',
  ...
  'user.gossip.description' => 'Enregistrer les informations relatives à cet évaluateurque vous souhaitez rendre visibles aux autres administrateurs, directeurs et rédacteurs. Ces informations seront visibles lors de futures évaluations.',
  ...
  'user.apiKey.generateWarning' => 'Générer une nouvelle clé API invalidera toute clé préexistante pour cet utilisateur.',
  'user.apiKey.secretRequired' => 'Avant de générer une clé API, l\'administrateur du site doit définir un secret dans le fichier de configuration ("api_key_secret").',
