<?php /* Smarty version 2.6.25-dev, created on 2019-02-27 14:15:00
         compiled from frontend/components/registrationForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'frontend/components/registrationForm.tpl', 21, false),array('function', 'html_options', 'frontend/components/registrationForm.tpl', 87, false),array('modifier', 'escape', 'frontend/components/registrationForm.tpl', 33, false),)), $this); ?>
...
" maxlength="40" required>
				...
				<div class="optin age_confirm">
			<label>
				<input type="checkbox" id="ageConfirm" name="ageConfirm" value="1">
				<?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "user.register.form.ageConfirmation"), $this);?>
