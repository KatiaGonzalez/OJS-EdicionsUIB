...
unset($_smarty_tpl_vars);
 ?>
	...
	<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "submission/submissionMetadataFormFields.tpl", 'smarty_include_vars' => array('readOnly' => $this->_tpl_vars['formParams']['readOnly'],'metadataModal' => true)));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
