<?php return array (
  ...
  'user.register.form.privacyConsentThisContext' => 'Sí acepto que mis datos se recopilen y almacenen de acuerdo con la política de privacidad de esta revista <a href="{$privacyUrl}" target="_blank">política de privacidad</a>.',
  'user.register.form.missingSiteConsent' => 'Debes aceptar la política de privacidad de este sitio',
