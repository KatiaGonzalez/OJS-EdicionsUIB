...
(Après l\'enregistrement, d\'autres commentaires peuvent être ajoutés.)',
  ...
  'user.register.reviewerDescription' => 'Disposé à faire des évaluations par les pairs des soumissions à la revue.',
...
<li>Utiliser <strong>*</strong> comme troncature dans un terme pour y faire correspondre toute séquence de caractères, c.-à-d. <em>soci* moralité</em> feront apparaître les documents contenant « sociologique » ou « socialisme »</li>
  ...
  'about.submissionPreparationChecklist.description' => 'Les auteurs doivent s\'assurer de la conformité de leur soumission avec l\'ensemble des éléments suivants. Les soumissions non conformes peuvent être retournées aux auteurs.',
...
<ol>
  ...
  'about.authorFees' => 'Frais pour les auteurs',
  'about.authorFeesMessage' => 'Cette revue prélève auprès des auteurs les frais suivants.',
...
Titre du système de classification',
  'manager.setup.basicEditorialStepsDescription' => 'Étapes : Soumission en attente &gt; Soumission en évaluation &gt; Soumission en révision &gt; Table des matières.<br /><br />Sélectionnez un modèle pour gérer ces aspects du processus éditorial. Pour désigner des Rédacteurs ou des Rédacteurs de rubrique, allez à Rédacteurs dans Gestion de la revue.)',
...
La validation peut échouer sur les URL de recherche qui nécessitent des formulaires de données enregistrés.',
  ...
  'payment.authorFees' => 'Frais pour les auteurs',
  ...
  'user.authorization.copyeditorAssignmentMissing' => 'Accès refusé! Vous n\'avez pas été désigné comme réviseur de cet article.',
...
L\'installation de CLOCKSS pour Open Journal Systems n\'a pas besoin d\'avoir lieu avant que la publication soit en cours.',
  ...
  'manager.setup.porticoDescription' => 'Portico est un service à but non lucratif voué à la préservation de publications numériques, notamment des revues électroniques, des livres électroniques et des collections historiques numérisées. Si votre revue a signé un contrat avec Portico, activez-le ici:',
  ...
  'payment.notFound' => 'La demande de paiement a expiré. Veuillez communiquer avec un responsable de la revue pour plus de détails.',
  ...
  'notification.type.publicationScheduled' => 'La publication de cet article a été planifiée.',
