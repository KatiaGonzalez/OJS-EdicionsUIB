<?php return array (
  ...
  'submission.submit.cancelSubmission' => 'A submissão pode ser concluída numa data posterior, clicando em Submissões Activas nas opções da página do Autor.',
  ...
  'submission.submit.selectSection' => 'Escolha uma secção...',
  ...
  'submission.submit.coverNote' => 'Comentários ao Editor',
  ...
  'author.submit.noSubmissionConfirm' => 'Deseja realmente continuar sem enviar um ficheiro ao sistema?',
  ...
  'author.submit.confirmationDescription' => 'Após a conclusão e verificação dos passos anteriores, clique em "Concluir submissão" para enviar o seu manuscrito para a revista {$journalTitle}. Será enviado um e-mail de confirmação e a situação da submissão dentro do processo editorial pode ser acompanhada ao aceder ao sistema. Agradecemos o seu interesse em contribuir com manuscritos para a revista {$journalTitle}.',
