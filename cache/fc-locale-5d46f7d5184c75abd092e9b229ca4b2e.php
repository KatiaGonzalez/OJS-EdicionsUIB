<?php return array (
  ...
  'editor.issues.futureIssues' => 'Propers números',
  ...
  'editor.issues.invalidCoverPageFormat' => 'El format de la portada no és vàlid. Els formats admesos són .gif, .jpg i .png.',
  ...
  'editor.issues.showCoverPage' => 'Crea una portada per a aquest número amb els elements següents:',
  'editor.issues.coverPageDisplay' => 'Visualització',
  'editor.issues.hideCoverPageArchives' => 'No mostris una miniatura de la imatge de la portada a la llista de números.',
  'editor.issues.hideCoverPageCover' => 'No mostris la imatge de la portada abans de la taula de continguts.',
  ...
  'editor.submissions.assignedTo' => 'Assignada a',
  ...
  'editor.article.showCoverPage' => 'Crea una portada per a aquest article amb els elements següents:',
  'editor.article.hideCoverPageToc' => 'No mostris una miniatura de la imatge de la portada a la taula de continguts.',
  'editor.article.hideCoverPageAbstract' => 'No mostris la imatge de la portada a la visualització del resum de l’article.',
  ...
  'editor.article.schedulePublication' => 'Programar per publicar',
