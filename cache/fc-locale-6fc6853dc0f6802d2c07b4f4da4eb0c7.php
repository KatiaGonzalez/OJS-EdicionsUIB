<?php return array (
  ...
  'manager.sections.hideTocAuthor' => 'Omettre les noms des auteurs pour les articles de cette rubrique dans les sommaires des numéros.',
...
Il y a des cas où seulement une seule statistique d\'utilisation doit être utilisée , ex. pour afficher une liste ordonnée des articles les plus utilisés ou pour classer les résultats de recherche. Veuillez sélectionner l\'une des mesures paramétrées comme celle par défaut.',
  ...
  'manager.setup.editorialTeam.description' => 'Inscrire la liste de personnes impliquées dans la revue (directeur, rédacteurs et autres).',
...
Il existe cinq niveaux d\'autorisation : Les Directeurs de revue ont accès à tout ce qui se trouve dans un journal (tous les contenus et les paramètres); Les Rédacteurs ont un accès complet à tout le contenu assigné; Les assistants de revue ont un accès limité aux seules soumissions qui leur ont été expressément attribuées par un éditeur; Les Évaluateurs peuvent voir et interagir avec les soumissions qui leur ont été assignés pour évaluation; Et les auteurs peuvent voir et interagir avec une quantité limitée d\'informations en lien avec  leurs propres soumissions. En outre, il y a cinq différentes étapes auquelles les rôles peuvent avoir accès : soumission, évaluation interne, évaluation (review), édition (editorial) et production (production).',
  ...
  'subscriptionManager.subscription.confirmRemove' => 'Êtes-vous certain de vouloir supprimer cet abonnement?',
  'manager.paymentTypes' => 'Types de paiement',
  'manager.setup.plnPluginEnable' => 'Plugiciel PKP PN activé',
  'manager.setup.plnDescription' => 'Le PKP Preservation Network (PN) fournit des services de préservation gratuits pour toutes les revues sur OJS répondant à quelques critères de base.',
  'manager.setup.plnSettingsDescription' => 'Cliquer sur le lien "Paramètres" pour accepter les conditions d\'utilisation de PKP PN.',
  'manager.setup.plnPluginArchiving' => 'PKP Preservation Network (PN)',
  'manager.setup.plnPluginNotInstalled' => 'Le PKP Preservation Network (PN) fournit des services de préservation gratuits pour toutes les revues sur OJS répondant à quelques critères de base. Le plugiciel PKP PN pour OJS 3 est présentement en développement et sera disponible dans la galerie de plugiciels bientôt.',
  'manager.setup.otherLockss' => 'Options d\'archivage alternatives',
  'manager.setup.porticoEnable' => 'Activer Portico pour stocker et distribuer le contenu de la revue aux bibliothèques participant à Portico.',
  ...
  'manager.subscriptionPolicies.expiryReminderAfterMonths' => 'Signaler par courriel l\'expiration de leur abonnement aux abonnés',
  'manager.subscriptionPolicies.expiryReminderAfterWeeks' => 'Signaler par courriel l\'expiration de leur abonnement aux abonnés',
  'manager.subscriptionPolicies.expiryReminderBeforeMonths' => 'Signaler par courriel l\'expiration prochaine de leur abonnement aux abonnés',
  'manager.subscriptionPolicies.expiryReminderBeforeWeeks' => 'Signaler par courriel l\'expiration prochaine de leur abonnement aux abonnés',
  'manager.subscriptions.confirmRenew' => 'Êtes-vous certain de vouloir renouveler cet abonnement?',
  'manager.navigationMenus.subscriptions.description' => 'Lien vers la page décrivant les abonnements offerts.',
  'manager.navigationMenus.mySubscriptions.description' => 'Lien vers la page décrivant les abonnements courants et passés aux utilisateurs.',
  'manager.navigationMenus.mySubscriptions.conditionalWarning' => 'Ce lien sera affiché uniquement si l\'utilisateur est connecté.',
