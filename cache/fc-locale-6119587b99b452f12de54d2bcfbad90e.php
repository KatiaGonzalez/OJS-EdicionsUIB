<?php return array (
  ...
  'author.competingInterests' => 'Conflicte&nbsp;d’interessos <a target="_new" class="action" href="{$competingInterestGuidelinesUrl}">Política&nbsp;de CI</a>',
  ...
  'submission.submit.cancelSubmission' => 'Podeu completar aquesta tramesa més endavant si seleccioneu «Trameses actives» a la pàgina d\'inici de l’autor/a.',
  ...
  'author.submit.howToSubmit' => 'En cas que necessiteu assistència, poseu-vos en contacte amb <a href="mailto:{$supportEmail}">{$supportName}</a> ({$supportPhone}).',
  'author.submit.howToSubmitNoPhone' => 'En cas que necessiteu assistència, poseu-vos en contacte amb <a href="mailto:{$supportEmail}">{$supportName}</a>.',
  'author.submit.journalSection' => 'Secció de la revista',
  'author.submit.journalSectionDescription' => 'Seleccioneu la secció adequada per a aquesta tramesa (vegeu «Seccions i Polítiques» a «<a href="{$aboutUrl}" target="_new">Sobre</a> la revista»).',
  'submission.submit.selectSection' => 'Seleccioneu una secció...',
  'author.submit.submissionChecklist' => 'Llista de verificació de tramesa',
  ...
  'author.submit.copyrightNoticeAgree' => 'Els autors/ores accepten les condicions d’aquest avís de drets d\'autor/a, que s’aplicarà quan aquesta tramesa es publiqui en aquesta revista (podeu incloure comentaris per a l’editor/a a continuació).',
  ...
  'author.submit.form.sectionRequired' => 'Seleccioneu una secció adequada de la revista per a aquesta tramesa.',
  'author.submit.form.localeRequired' => 'Seleccioneu la llengua per a la tramesa.',
  'submission.submit.privacyStatement' => 'Declaració de privacitat de la revista',
  ...
  'author.submit.languageInstructions' => 'Anglès=en; francès=fr; castellà=es. <a href="http://www.loc.gov/standards/iso639-2/php/code_list.php" target="_blank">Codis addicionals</a>.',
