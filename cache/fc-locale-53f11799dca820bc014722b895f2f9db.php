<?php return array (
  ...
  'manager.setup.reviewOptions.showEnsuringLink' => 'Fournir un lien vers <a href="javascript:openHelp(\'{$blindReviewHelpId}\')" class="action">Assurer une évaluation à l\'aveugle</a> dans les pages où les auteurs et les rapporteurs peuvent télécharger des fichiers.',
