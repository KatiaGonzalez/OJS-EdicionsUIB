<?php return array (
  ...
  'user.firstName' => 'Nom',
  'user.initialsExample' => 'Pere Martí Valls = PMV',
  'user.initials' => 'Inicials',
  'user.interests' => 'Interessos de revisió',
  'user.interests.description' => '(Separeu els interessos mitjançant la tecla de retorn o la tecla de coma)',
  ...
  'user.login.loginError' => 'El nom d\'usuari/ària o la contrasenya són no vàlids. Torneu-ho a intentar.',
  ...
  'user.login.lostPassword.invalidUser' => 'No existeix cap usuari/usuària amb l’adreça electrònica especificada.',
  ...
  'user.logOutAs' => 'Surt de la sessió com a',
  'user.hello' => 'Hola,',
  'user.mailingAddress' => 'Adreça postal',
  'user.middleName' => 'Segon nom',
  ...
  'user.profile.form.ageRequired' => 'Has de esser major de 16 anys',
  ...
  'user.profile.form.affiliationRequired' => 'Cal que introduïu una institució.',
  'user.profile.form.firstNameRequired' => 'Heu d’introduir un nom.',
  'user.profile.form.lastNameRequired' => 'Heu d’introduir un cognom.',
  ...
  'user.profile.form.urlInvalid' => 'L\'URL especificat no és vàlid. Comproveu l\'enllaç URL i torneu-ho a intentar. (Consell: proveu d\'afegir «http://» al principi de l\'URL).',
  ...
  'user.login.registerNewAccount' => 'Encara no sou usuari? Registreu-vos a través d\'aquest lloc.',
  ...
  'user.register.form.changePasswordRequired' => 'La opció de canvi de contrasenya es obligatòria.',
  'user.register.form.emailExists' => 'Ja hi ha un altre usuari/usuària que utilitza l’adreça electrònica seleccionada.',
  'user.register.form.passwordBadFormat' => 'La contrasenya ha de contenir almenys una lletra i un dígit.',
  ...
  'user.register.passwordLengthRestriction' => 'La contrasenya ha de tenir {$length} caràcters com a mínim.',
  ...
  'user.roles' => 'Rols',
  'user.salutation' => 'Tractament',
  'user.sendPassword' => 'Confirmació',
  'user.sendPassword.description' => 'Envia’m una confirmació per correu electrònic amb el nom d’usuari i la contrasenya.',
  'user.signature' => 'Signatura',
  'user.suffix' => 'Grau jeràrquic',
  'user.title' => 'Títol',
  'user.url' => 'URL',
  'user.userHome' => 'Pàgina inicial de l’usuari/usuària',
  'user.username' => 'Nom d’usuari',
  'user.workingLanguages' => 'Llengües de treball',
  'user.register.completeForm' => 'Empleneu aquest formulari per registrar-vos en aquesta revista.',
  ...
  'user.authorization.pluginRequired' => 'No s\'ha especificat cap mòdul.',
  ...
  'user.privacyLink' => 'Les seves dades s\'han emmagatzemat d\'acord amb la nostra <a href="{$privacyUrl}" target="_blank">declaració de privacitat</a>.',
  'user.profile.form.privacyConsentRequired' => 'Ha d\'acceptar els termes de la declaració de privacitat.',
  'user.register.form.emailConsent' => 'Sí, desitjo que em notifiquin sobre noves publicacions i avisos.',
  'user.register.form.privacyConsent' => 'Sí, consenteixo que les meves dades es recopilen i s\'emmagatzemin d\'acord amb la <a href="{$privacyUrl}" target="_blank"> declaració de polítiques </a>.',
  ...
  'user.orcid.orcidInvalid' => 'L\'identificador ORCID especificat no es vàlid. Inclogui el URI complet (p. ex.: "http://orcid.org/0000-0002-1825-0097"), si us plau.',
  'user.register.form.ageConfirmation' => 'Declaro tenir més de 16 anys',
); ?>