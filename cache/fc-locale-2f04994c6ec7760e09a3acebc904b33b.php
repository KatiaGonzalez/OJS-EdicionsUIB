...
(Après l\'enregistrement, d\'autres commentaires peuvent être ajoutés.)',
  ...
  'user.register.form.privacyConsentThisContext' => 'J\'accepte que mes données soient collectées et stockées conformément à la politique de confidentialité de ce magazine <a href="{$privacyUrl}" target="_blank"> Politique de confidentialité</a>.',
  'user.register.form.missingSiteConsent' => 'Vous devez accepter la politique de confidentialité du site',
